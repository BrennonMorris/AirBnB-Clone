    ...
    if (url === '/' || url.includes('new') || url.includes('current') || url.includes('update')) {
        footerCode = (
            <div className='footer'>
                ...
                <div className='hpfooter-left'>
                    <span className='clonebnb-footer'>
                    © 2022 CloneBnB, Inc.
                    </span>
                    <span className='middot'>&middot;</span>
                    <span className='brennon-span'>
                        <a className='footer-tag' href='https://www.linkedin.com/in/brennonmorris/' rel="noopener noreferrer" target='_blank'>Brennon Morris</a>
                    </span>
                    <span className='middot'>&middot;</span>
                    <span className='repo-span'>
                        <a className='footer-tag' href='https://github.com/BrennonMorris/Air-BnB-Clone' rel="noopener noreferrer" target='_blank'>Site Repo</a>
                    </span>
                </div>
                <div className='hpfooter-right'>
                    <a href='https://github.com/BrennonMorris' rel="noopener noreferrer" target='_blank'>
                    ...
                    <a href='https://www.linkedin.com/in/brennonmorris/' rel="noopener noreferrer" target='_blank'>
        ...
        footerCode = (
            <div className='footer-otherpages'>
                ...
                <div className='footer-bottom-brennon'>
                    <span className='brennon-span'>
                        <a className='footer-tag' href='https://www.linkedin.com/in/brennonmorris/' rel="noopener noreferrer" target='_blank'>Brennon Morris</a>
                    </span>
                    <span className='middot'>&middot;</span>
